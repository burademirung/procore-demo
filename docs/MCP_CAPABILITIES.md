...
|---|---|---|---|---|
| **Tools** (model-controlled, structured output + annotations) | Sync project / financials / RFI→Case | `sync_procore_project_to_salesforce`, `sync_procore_financials`, `create_salesforce_case_from_rfi` (all with `outputSchema` + `annotations`) | [server/2025-06-18](https://modelcontextprotocol.io/specification/2025-06-18/server) | **Implemented** ✓ tested |
